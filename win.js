...
//     // Update the score display in the result page
...
//         // Reset the game and go back to the main game page
//         window.location.href = 'home.html';
//     });

//     // Event listener for the "Next" button
//     document.getElementById('nextButton').addEventListener('click', function() {
//         // Proceed to the next action or celebration page
//         window.location.href = 'hurray.html';
//     });
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   let computerChoice = sessionStorage.getItem('computerChoice');
    ...
    // Map choices to the corresponding image paths
    let choiceImages = {
       'option1': 'icons/17911 1.png',
        'option2': 'icons/icons8-peace-hand-67 1.png',
        'option3': 'icons/icons8-peace-hand-67 1.png'
    };
