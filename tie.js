...
//     const playerImage = document.querySelector('.opt1');
//     const computerImage = document.querySelector('.opt2');
...
// }
    ...
    // Event listener for the "Next" button
    document.getElementById('nextButton').addEventListener('click', function() {
        window.location.href = 'tie_next.html'; // Redirect to the next page, specific to a tie scenario
    });
